...
/**
 * 99Freelas field selectors with fallbacks. The parser tries each selector in
...
function parseBudget(text) {
  ...
  // 99Freelas usually displays budget in BRL ranges.
  const min = numbers[0];
...
/**
 * Pure parser for 99Freelas projects HTML.
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { parseFreelas99, SELECTORS };
}
