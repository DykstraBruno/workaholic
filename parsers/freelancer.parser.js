...
/**
 * Freelancer.com field selectors with fallbacks. The parser tries each
 * selector in order and uses the first non-empty match.
 */
const SELECTORS = {
  card: [
    'li:has(a[href*="/projects/"])',
    '.JobSearchCard-item',
    '[data-bid-id]',
    '.project-item',
  ],
  ...
  postedAt: [
    'time[datetime]',
    '.JobSearchCard-primary-stat time',
    '.project-age',
  ],
};
...
/**
 * Pure parser for Freelancer.com jobs HTML.
...
function parseFreelancer(html) {
  try {
    ...
    return cards.map((card) => {
      ...
      const url = toAbsoluteUrl(href, 'https://www.freelancer.com');
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { parseFreelancer, SELECTORS };
}

if (typeof globalThis !== 'undefined') {
  globalThis.parseFreelancer = parseFreelancer;
  globalThis.FREELANCER_SELECTORS = SELECTORS;
}
