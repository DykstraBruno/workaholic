...
/**
 * Workana field selectors with fallbacks. The parser tries each selector in
...
/**
 * Pure parser for Workana jobs HTML.
...
function parseWorkana(html) {
  try {
    ...
    return cards.map((card) => {
      ...
      const url = toAbsoluteUrl(href, 'https://www.workana.com');
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { parseWorkana, SELECTORS };
}
